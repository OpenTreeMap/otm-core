...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ExportJob.created'
        db.add_column(u'exporter_exportjob', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ExportJob.modified'
        db.add_column(u'exporter_exportjob', 'modified',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ExportJob.description'
        db.add_column(u'exporter_exportjob', 'description',
                      self.gf('django.db.models.fields.CharField')(default='[no description]', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ExportJob.created'
        db.delete_column(u'exporter_exportjob', 'created')

        # Deleting field 'ExportJob.modified'
        db.delete_column(u'exporter_exportjob', 'modified')

        # Deleting field 'ExportJob.description'
        db.delete_column(u'exporter_exportjob', 'description')
    ...
    models = {
        ...
        u'exporter.exportjob': {
            ...
            'outfile': ('django.db.models.fields.files.FileField', [], {'max_length': '100'}),
            'status': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['treemap.User']", 'null': 'True', 'blank': 'True'})
        },
