...
#
STORAGE_UNITS = {"greenInfrastructure": {"area": "sq_m"}}
DISPLAY_DEFAULTS = {
    "plot": {
    ...
    "bioswale": {"drainage_area": {"units": "sq_ft", "digits": 1}},
    "rainBarrel": {"capacity": {"units": "gal", "digits": 1}},
    "rainGarden": {"drainage_area": {"units": "sq_ft", "digits": 1}},
    "greenInfrastructure": {
...
WEBPACK_LOADER = {
    "DEFAULT": {
        ...
        "STATS_FILE": os.path.join(PROJECT_ROOT, "static", "webpack-stats.json"),
    }
}
