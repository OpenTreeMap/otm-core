...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.firstname'
        db.add_column(u'treemap_user', 'firstname',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'User.lastname'
        db.add_column(u'treemap_user', 'lastname',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'User.organization'
        db.add_column(u'treemap_user', 'organization',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'User.allow_email_contact'
        db.add_column(u'treemap_user', 'allow_email_contact',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.firstname'
        db.delete_column(u'treemap_user', 'firstname')

        # Deleting field 'User.lastname'
        db.delete_column(u'treemap_user', 'lastname')

        # Deleting field 'User.organization'
        db.delete_column(u'treemap_user', 'organization')

        # Deleting field 'User.allow_email_contact'
        db.delete_column(u'treemap_user', 'allow_email_contact')
