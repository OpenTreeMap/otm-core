...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Instance.config'
        db.add_column(u'treemap_instance', 'config',
                      self.gf('treemap.instance.JSONField')(default={}),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Instance.config'
        db.delete_column(u'treemap_instance', 'config')
