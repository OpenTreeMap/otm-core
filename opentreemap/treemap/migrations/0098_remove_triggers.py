...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        db.execute("""
DROP TRIGGER IF EXISTS RevInsertTrigger ON treemap_mapfeature;
DROP TRIGGER IF EXISTS RevUpdateTrigger ON treemap_mapfeature;
DROP TRIGGER IF EXISTS RevDeleteTrigger ON treemap_mapfeature;
