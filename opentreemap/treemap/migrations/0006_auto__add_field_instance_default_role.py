...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'treemap_user_roles', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('user', models.ForeignKey(orm[u'treemap.user'], null=False)),
            ('role', models.ForeignKey(orm[u'treemap.role'], null=False))
        ))
        db.create_unique(u'treemap_user_roles', ['user_id', 'role_id'])

        # Adding field 'Instance.default_role'
        db.add_column(u'treemap_instance', 'default_role',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name=u'default_role', to=orm['treemap.Role']),
                      keep_default=False)


    def backwards(self, orm):
        # Removing M2M table for field roles on 'User'
        db.delete_table('treemap_user_roles')

        # Deleting field 'Instance.default_role'
        db.delete_column(u'treemap_instance', 'default_role_id')
