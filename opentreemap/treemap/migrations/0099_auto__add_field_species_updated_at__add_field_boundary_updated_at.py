...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Species.updated_at'
        db.add_column(u'treemap_species', 'updated_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, db_index=True, blank=True),
                      keep_default=False)

        # Adding field 'Boundary.updated_at'
        db.add_column(u'treemap_boundary', 'updated_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, db_index=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Species.updated_at'
        db.delete_column(u'treemap_species', 'updated_at')

        # Deleting field 'Boundary.updated_at'
        db.delete_column(u'treemap_boundary', 'updated_at')
