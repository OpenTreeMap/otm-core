...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Species.cultivar_name'
        db.delete_column(u'treemap_species', 'cultivar_name')


    def backwards(self, orm):
        # Adding field 'Species.cultivar_name'
        db.add_column(u'treemap_species', 'cultivar_name',
