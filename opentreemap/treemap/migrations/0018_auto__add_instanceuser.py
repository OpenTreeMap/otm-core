...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'InstanceUser'
        db.create_table(u'treemap_instanceuser', (
        ...
        db.send_create_signal(u'treemap', ['InstanceUser'])


    def backwards(self, orm):
        # Deleting model 'InstanceUser'
        db.delete_table(u'treemap_instanceuser')
