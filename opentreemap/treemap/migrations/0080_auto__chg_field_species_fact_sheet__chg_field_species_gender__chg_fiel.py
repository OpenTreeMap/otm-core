...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Species.fact_sheet'
        db.alter_column(u'treemap_species', 'fact_sheet', self.gf('django.db.models.fields.URLField')(default='', max_length=255))

        # Changing field 'Species.gender'
        db.alter_column(u'treemap_species', 'gender', self.gf('django.db.models.fields.CharField')(default='', max_length=50))

        # Changing field 'Species.bloom_period'
        db.alter_column(u'treemap_species', 'bloom_period', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'Species.other'
        db.alter_column(u'treemap_species', 'other', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'Species.fruit_period'
        db.alter_column(u'treemap_species', 'fruit_period', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'Species.plant_guide'
        db.alter_column(u'treemap_species', 'plant_guide', self.gf('django.db.models.fields.URLField')(default='', max_length=255))

        # Changing field 'Species.cultivar'
        db.alter_column(u'treemap_species', 'cultivar', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'Species.species'
        db.alter_column(u'treemap_species', 'species', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

    def backwards(self, orm):

        # Changing field 'Species.fact_sheet'
        db.alter_column(u'treemap_species', 'fact_sheet', self.gf('django.db.models.fields.URLField')(max_length=255, null=True))

        # Changing field 'Species.gender'
        db.alter_column(u'treemap_species', 'gender', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'Species.bloom_period'
        db.alter_column(u'treemap_species', 'bloom_period', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Species.other'
        db.alter_column(u'treemap_species', 'other', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Species.fruit_period'
        db.alter_column(u'treemap_species', 'fruit_period', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Species.plant_guide'
        db.alter_column(u'treemap_species', 'plant_guide', self.gf('django.db.models.fields.URLField')(max_length=255, null=True))

        # Changing field 'Species.cultivar'
        db.alter_column(u'treemap_species', 'cultivar', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Species.species'
        db.alter_column(u'treemap_species', 'species', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
