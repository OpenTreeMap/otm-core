    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "thumbnail",
                    models.ImageField(null=True, upload_to="users", blank=True),
                ),
                (
                    "first_name",
                    models.CharField(
                        default="", max_length=30, verbose_name="first name", blank=True
                    ),
                ),
                (
                    "last_name",
                    models.CharField(
                        default="", max_length=30, verbose_name="last name", blank=True
                    ),
                ),
                (
                    "organization",
            ...
            fields=[
                ...
                (
                    ...
                    django.contrib.gis.db.models.fields.MultiPolygonField(
                        srid=3857, db_column="the_geom_webmercator"
                    ),
                ),
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        max_length=255,
                        validators=[
                            treemap.instance.reserved_name_validator,
                            django.core.validators.RegexValidator(
                                "^[a-zA-Z]+[a-zA-Z0-9\\-]*$",
                                'Must start with a letter and may only contain letters, numbers, or dashes ("-")',
                                "Invalid URL name",
                            ),
                        ],
                    ),
                ...
                (
                    ...
                    models.CharField(
                        ...
                        null=True,
                        choices=[
                            (b"TpIntWBOI", b"Temperate Interior West"),
                            (b"NoEastXXX", b"Northeast"),
                            (b"CaNCCoJBK", b"Northern California Coast"),
                            (b"InterWABQ", b"Interior West"),
                            (b"InlEmpCLM", b"Inland Empire"),
                            (b"LoMidWXXX", b"Lower Midwest"),
                            (b"MidWstMSP", b"Midwest"),
                            (b"NMtnPrFNL", b"North"),
                            (b"PacfNWLOG", b"Pacific Northwest"),
                            (b"PiedmtCLT", b"South"),
                            (b"SoCalCSMA", b"Southern California Coast"),
                            (b"GulfCoCHS", b"Coastal Plain"),
                            (b"SWDsrtGDL", b"Southwest Desert"),
                            (b"InlValMOD", b"Inland Valleys"),
                            (b"CenFlaXXX", b"Central Florida"),
                            (b"TropicPacXXX", b"Tropical"),
                        ],
                    ),
                ),
                ...
                (
                    "boundaries",
                    models.ManyToManyField(
                        to="treemap.Boundary", null=True, blank=True
                    ),
                ),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "address_street",
                    models.CharField(
                        help_text="Address", max_length=255, null=True, blank=True
                    ),
                ),
                (
                    "address_city",
                    models.CharField(
                        help_text="City", max_length=255, null=True, blank=True
                    ),
                ),
                (
                    "address_zip",
                    models.CharField(
                        help_text="Postal Code", max_length=30, null=True, blank=True
                    ),
                ),
                ...
                (
                    "updated_at",
                    models.DateTimeField(
                        default=django.utils.timezone.now, help_text="Last Updated"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "image",
                    models.ImageField(upload_to="trees/%Y/%m/%d", editable=False),
                ),
                (
                    "thumbnail",
                    models.ImageField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "instance",
                    models.ForeignKey(blank=True, to="treemap.Instance", null=True),
                ),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "diameter",
                    models.FloatField(help_text="Tree Diameter", null=True, blank=True),
                ),
                (
                    "height",
                    models.FloatField(help_text="Tree Height", null=True, blank=True),
                ),
                (
                    "canopy_height",
                    models.FloatField(help_text="Canopy Height", null=True, blank=True),
                ),
                (
                    "date_planted",
                    models.DateField(help_text="Date Planted", null=True, blank=True),
                ),
                (
                    "date_removed",
                    models.DateField(help_text="Date Removed", null=True, blank=True),
                ),
                ("instance", models.ForeignKey(to="treemap.Instance")),
                (
                    "species",
                    models.ForeignKey(
                        blank=True, to="treemap.Species", help_text="Species", null=True
                    ),
                ),
            ],
            options={"abstract": False,},
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "width",
                    models.FloatField(help_text="Plot Width", null=True, blank=True),
                ),
                (
                    "length",
                    models.FloatField(help_text="Plot Length", null=True, blank=True),
                ),
                (
                    "owner_orig_id",
                    models.CharField(max_length=255, null=True, blank=True),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                blank=True, to="treemap.BenefitCurrencyConversion", null=True
            ),
        ),
        migrations.AddField(
            model_name="instance",
        ...
        migrations.AddField(
            model_name="tree", name="plot", field=models.ForeignKey(to="treemap.Plot"),
        ),
        ...
        migrations.AlterUniqueTogether(
            name="instanceuser", unique_together=set([("instance", "user")]),
        ),
        migrations.AlterUniqueTogether(
            name="fieldpermission",
        ...
        migrations.AlterUniqueTogether(
            name="favorite", unique_together=set([("user", "map_feature")]),
        ),
        migrations.AlterIndexTogether(
            name="audit", index_together=set([("instance", "user", "updated")]),
        ),
    ]
