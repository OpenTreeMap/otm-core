...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MapFeature.updated_at'
        db.add_column(u'treemap_mapfeature', 'updated_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=timezone.now),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MapFeature.updated_at'
        db.delete_column(u'treemap_mapfeature', 'updated_at')
