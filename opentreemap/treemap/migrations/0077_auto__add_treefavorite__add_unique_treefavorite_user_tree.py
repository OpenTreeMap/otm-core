...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'treemap_treefavorite', (
        ...
        db.send_create_signal(u'treemap', ['TreeFavorite'])

        # Adding unique constraint on 'TreeFavorite', fields ['user', 'tree']
        db.create_unique(u'treemap_treefavorite', ['user_id', 'tree_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'TreeFavorite', fields ['user', 'tree']
        db.delete_unique(u'treemap_treefavorite', ['user_id', 'tree_id'])

        # Deleting model 'TreeFavorite'
        db.delete_table(u'treemap_treefavorite')
