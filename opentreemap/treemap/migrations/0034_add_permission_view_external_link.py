...
_new_permission_codename = 'view_external_link_on_detail_page'
_default_role_names = ['administrator', 'editor']


def add_permission(apps, schema_editor):
    Permission, Instance, instance_content_type = _get_models(apps)
...
def _get_models(apps):
    ...
    return Permission, Instance, instance_content_type
