...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Audit', fields ['current_value']
        db.create_index(u'treemap_audit', ['current_value'])


    def backwards(self, orm):
        # Removing index on 'Audit', fields ['current_value']
        db.delete_index(u'treemap_audit', ['current_value'])
