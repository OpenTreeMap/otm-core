...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Instance.basemap_type'
        db.add_column(u'treemap_instance', 'basemap_type',
                      self.gf('django.db.models.fields.CharField')(default=u'google', max_length=255),
                      keep_default=False)
        db.add_column(u'treemap_instance', 'basemap_data',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Instance.basemap_type'
        db.delete_column(u'treemap_instance', 'basemap_type')
        db.delete_column(u'treemap_instance', 'basemap_data')
