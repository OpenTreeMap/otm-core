...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.make_info_public'
        db.add_column(u'treemap_user', 'make_info_public',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.make_info_public'
        db.delete_column(u'treemap_user', 'make_info_public')
