...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        # Some fields in previously-imported species objects have leading or
        # trailing spaces. This data migration strips leading and trailing
        # spaces from all Species fields in all instances. Going forward the
        # importer will ensure that all incoming Species fields are stripped.
        fields = [
            'common_name',
            'genus',
            'species',
        ...
        for species in orm.Species.objects.all():
            ...
            for field in fields:
                ...
                if value:
                    ...
                    if stripped != value:
                        setattr(species, field, stripped)
                        changed = True
            if changed:
                species.save()
