...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Boundary.geom' to match new field type.
        db.rename_column(u'treemap_boundary', 'geom', u'the_geom_webmercator')
        # Changing field 'Boundary.geom'
        db.alter_column(u'treemap_boundary', u'the_geom_webmercator', self.gf('django.contrib.gis.db.models.fields.MultiPolygonField')(srid=3857, db_column=u'the_geom_webmercator'))

    def backwards(self, orm):

        # Renaming column for 'Boundary.geom' to match new field type.
        db.rename_column(u'treemap_boundary', u'the_geom_webmercator', 'geom')
        # Changing field 'Boundary.geom'
        db.alter_column(u'treemap_boundary', 'geom', self.gf('django.contrib.gis.db.models.fields.MultiPolygonField')(srid=3857))
