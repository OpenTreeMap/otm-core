...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ReputationMetric'
        db.create_table(u'treemap_reputationmetric', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('instance', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['treemap.Instance'], null=True, blank=True)),
            ...
            ('direct_write_score', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('approval_score', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('denial_score', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'treemap', ['ReputationMetric'])

        # Adding field 'User.reputation'
        db.add_column(u'treemap_user', 'reputation',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


        # Changing field 'Audit.instance'
        db.alter_column(u'treemap_audit', 'instance_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['treemap.Instance'], null=True))

    def backwards(self, orm):
        # Deleting model 'ReputationMetric'
        db.delete_table(u'treemap_reputationmetric')

        # Deleting field 'User.reputation'
        db.delete_column(u'treemap_user', 'reputation')

        # User chose to not deal with backwards NULL issues for 'Audit.instance'
        raise RuntimeError("Cannot reverse this migration. 'Audit.instance' and its values cannot be restored.")
