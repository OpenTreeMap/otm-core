...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'treemap_fieldpermission', (
            ...
            ('role', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['treemap.Role'])),
            ('instance', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['treemap.Instance'])),
            ('type', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'treemap', ['FieldPermission'])

        # Adding model 'Role'
        db.create_table(u'treemap_role', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('instance', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['treemap.Instance'], null=True, blank=True)),
            ('rep_thresh', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'treemap', ['Role'])


    def backwards(self, orm):
        # Deleting model 'FieldPermission'
        db.delete_table(u'treemap_fieldpermission')

        # Deleting model 'Role'
        db.delete_table(u'treemap_role')
