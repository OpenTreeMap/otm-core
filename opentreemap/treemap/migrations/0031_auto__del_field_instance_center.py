...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Instance.center'
        raise RuntimeError("Cannot reverse this migration. 'Instance.center' and its values cannot be restored.")
