...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Tree.udfs'
        db.add_column(u'treemap_tree', 'udfs',
        ...
        # Adding field 'Plot.udfs'
        db.add_column(u'treemap_plot', 'udfs',
                      self.gf('treemap.udf.UDFField')(default='', db_index=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Tree.udf_scalar_values'
        raise RuntimeError("Cannot reverse this migration. 'Tree.udf_scalar_values' and its values cannot be restored.")
        # Deleting field 'Tree.udfs'
        db.delete_column(u'treemap_tree', 'udfs')

        # Adding field 'Plot.udf_scalar_values'
        db.add_column(u'treemap_plot', 'udf_scalar_values',
                      self.gf('treemap.udf.UDFField')(default={}, blank=True, db_index=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'treemap.instance': {
            ...
            'config': ('treemap.instance.JSONField', [], {'blank': 'True'}),
