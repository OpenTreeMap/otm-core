...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Tree.import_event'
        db.add_column(u'treemap_tree', 'import_event',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['treemap.ImportEvent'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Plot.import_event'
        db.add_column(u'treemap_plot', 'import_event',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['treemap.ImportEvent'], null=True, blank=True),
                      keep_default=False)
