...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Instance.adjuncts_timestamp'
        db.add_column(u'treemap_instance', 'adjuncts_timestamp',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Instance.adjuncts_timestamp'
        db.delete_column(u'treemap_instance', 'adjuncts_timestamp')
