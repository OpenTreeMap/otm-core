...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Audit.updated'
        db.alter_column(u'treemap_audit', 'updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'Audit.created'
        db.alter_column(u'treemap_audit', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'Audit.updated'
        db.alter_column(u'treemap_audit', 'updated', self.gf('django.db.models.fields.DateField')(auto_now=True))

        # Changing field 'Audit.created'
        db.alter_column(u'treemap_audit', 'created', self.gf('django.db.models.fields.DateField')(auto_now_add=True))
