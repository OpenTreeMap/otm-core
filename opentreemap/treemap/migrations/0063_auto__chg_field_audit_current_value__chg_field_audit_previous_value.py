...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Audit.current_value'
        db.alter_column(u'treemap_audit', 'current_value', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Audit.previous_value'
        db.alter_column(u'treemap_audit', 'previous_value', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'Audit.current_value'
        db.alter_column(u'treemap_audit', 'current_value', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Audit.previous_value'
        db.alter_column(u'treemap_audit', 'previous_value', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
