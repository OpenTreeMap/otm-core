...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'BenefitCurrencyConversion.airquality_aggregate_lb_to_currency'
        db.delete_column(u'treemap_benefitcurrencyconversion', 'airquality_aggregate_lb_to_currency')

        # Deleting field 'BenefitCurrencyConversion.carbon_dioxide_lb_to_currency'
        db.delete_column(u'treemap_benefitcurrencyconversion', 'carbon_dioxide_lb_to_currency')

        # Deleting field 'BenefitCurrencyConversion.stormwater_gal_to_currency'
        db.delete_column(u'treemap_benefitcurrencyconversion', 'stormwater_gal_to_currency')

        # Deleting field 'BenefitCurrencyConversion.kwh_to_currency'
        db.delete_column(u'treemap_benefitcurrencyconversion', 'kwh_to_currency')

        # Adding field 'BenefitCurrencyConversion.electricity_kwh_to_currency'
        db.add_column(u'treemap_benefitcurrencyconversion', 'electricity_kwh_to_currency',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)

        # Adding field 'BenefitCurrencyConversion.natural_gas_kbtu_to_currency'
        db.add_column(u'treemap_benefitcurrencyconversion', 'natural_gas_kbtu_to_currency',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)

        # Adding field 'BenefitCurrencyConversion.h20_gal_to_currency'
        db.add_column(u'treemap_benefitcurrencyconversion', 'h20_gal_to_currency',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)

        # Adding field 'BenefitCurrencyConversion.co2_lb_to_currency'
        db.add_column(u'treemap_benefitcurrencyconversion', 'co2_lb_to_currency',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)

        # Adding field 'BenefitCurrencyConversion.o3_lb_to_currency'
        db.add_column(u'treemap_benefitcurrencyconversion', 'o3_lb_to_currency',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)

        # Adding field 'BenefitCurrencyConversion.nox_lb_to_currency'
        db.add_column(u'treemap_benefitcurrencyconversion', 'nox_lb_to_currency',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)

        # Adding field 'BenefitCurrencyConversion.pm10_lb_to_currency'
        db.add_column(u'treemap_benefitcurrencyconversion', 'pm10_lb_to_currency',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)

        # Adding field 'BenefitCurrencyConversion.sox_lb_to_currency'
        db.add_column(u'treemap_benefitcurrencyconversion', 'sox_lb_to_currency',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)

        # Adding field 'BenefitCurrencyConversion.voc_lb_to_currency'
        db.add_column(u'treemap_benefitcurrencyconversion', 'voc_lb_to_currency',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'BenefitCurrencyConversion.airquality_aggregate_lb_to_currency'
        db.add_column(u'treemap_benefitcurrencyconversion', 'airquality_aggregate_lb_to_currency',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)

        # Adding field 'BenefitCurrencyConversion.carbon_dioxide_lb_to_currency'
        db.add_column(u'treemap_benefitcurrencyconversion', 'carbon_dioxide_lb_to_currency',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)

        # Adding field 'BenefitCurrencyConversion.stormwater_gal_to_currency'
        db.add_column(u'treemap_benefitcurrencyconversion', 'stormwater_gal_to_currency',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)

        # Adding field 'BenefitCurrencyConversion.kwh_to_currency'
        db.add_column(u'treemap_benefitcurrencyconversion', 'kwh_to_currency',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)

        # Deleting field 'BenefitCurrencyConversion.electricity_kwh_to_currency'
        db.delete_column(u'treemap_benefitcurrencyconversion', 'electricity_kwh_to_currency')

        # Deleting field 'BenefitCurrencyConversion.natural_gas_kbtu_to_currency'
        db.delete_column(u'treemap_benefitcurrencyconversion', 'natural_gas_kbtu_to_currency')

        # Deleting field 'BenefitCurrencyConversion.h20_gal_to_currency'
        db.delete_column(u'treemap_benefitcurrencyconversion', 'h20_gal_to_currency')

        # Deleting field 'BenefitCurrencyConversion.co2_lb_to_currency'
        db.delete_column(u'treemap_benefitcurrencyconversion', 'co2_lb_to_currency')

        # Deleting field 'BenefitCurrencyConversion.o3_lb_to_currency'
        db.delete_column(u'treemap_benefitcurrencyconversion', 'o3_lb_to_currency')

        # Deleting field 'BenefitCurrencyConversion.nox_lb_to_currency'
        db.delete_column(u'treemap_benefitcurrencyconversion', 'nox_lb_to_currency')

        # Deleting field 'BenefitCurrencyConversion.pm10_lb_to_currency'
        db.delete_column(u'treemap_benefitcurrencyconversion', 'pm10_lb_to_currency')

        # Deleting field 'BenefitCurrencyConversion.sox_lb_to_currency'
        db.delete_column(u'treemap_benefitcurrencyconversion', 'sox_lb_to_currency')

        # Deleting field 'BenefitCurrencyConversion.voc_lb_to_currency'
        db.delete_column(u'treemap_benefitcurrencyconversion', 'voc_lb_to_currency')
