...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Renaming model 'BoundaryZones' to 'Boundary'
        db.rename_table(u'treemap_boundaryzones', u'treemap_boundary')
        db.send_create_signal(u'treemap', ['Boundary'])


    def backwards(self, orm):
        # Adding model 'Boundary' to 'BoundaryZones'
        db.rename_table(u'treemap_boundary', u'treemap_boundaryzones')
