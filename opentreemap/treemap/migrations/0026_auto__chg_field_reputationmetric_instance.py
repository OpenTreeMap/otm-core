...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ReputationMetric.instance'
        db.alter_column(u'treemap_reputationmetric', 'instance_id', self.gf('django.db.models.fields.related.ForeignKey')(default=-1, to=orm['treemap.Instance']))

    def backwards(self, orm):

        # Changing field 'ReputationMetric.instance'
        db.alter_column(u'treemap_reputationmetric', 'instance_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['treemap.Instance'], null=True))
