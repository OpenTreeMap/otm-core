...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Audit', fields ['updated']
        db.create_index(u'treemap_audit', ['updated'])


    def backwards(self, orm):
        # Removing index on 'Audit', fields ['updated']
        db.delete_index(u'treemap_audit', ['updated'])
