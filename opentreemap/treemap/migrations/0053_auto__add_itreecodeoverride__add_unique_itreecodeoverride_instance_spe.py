...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ITreeCodeOverride'
        db.create_table(u'treemap_itreecodeoverride', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('instance_species', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['treemap.Species'])),
            ('region', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['treemap.ITreeRegion'])),
            ('itree_code', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal(u'treemap', ['ITreeCodeOverride'])

        # Adding unique constraint on 'ITreeCodeOverride', fields ['instance_species', 'region']
        db.create_unique(u'treemap_itreecodeoverride', ['instance_species_id', 'region_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'ITreeCodeOverride', fields ['instance_species', 'region']
        db.delete_unique(u'treemap_itreecodeoverride', ['instance_species_id', 'region_id'])

        # Deleting model 'ITreeCodeOverride'
        db.delete_table(u'treemap_itreecodeoverride')
