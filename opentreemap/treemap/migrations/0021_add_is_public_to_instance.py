...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Instance.is_public'
        db.add_column(u'treemap_instance', 'is_public',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Instance.is_public'
        db.delete_column(u'treemap_instance', 'is_public')
