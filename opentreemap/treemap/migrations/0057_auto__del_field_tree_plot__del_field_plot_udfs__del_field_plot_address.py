...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Tree.plot'
        db.delete_column(u'treemap_tree', 'plot_id')

        # Manual insertion by RM -- rename 'Tree.map_feature' as 'Tree.plot', and make non-Null
        db.rename_column(u'treemap_tree', 'map_feature_id', 'plot_id')
        db.alter_column(u'treemap_tree', 'plot_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['treemap.MapFeature']))
        ...
        # Deleting field 'Plot.id'
        db.delete_column(u'treemap_plot', u'id')
        ...
        # Changing field 'Plot.mapfeature_ptr'
        db.alter_column(u'treemap_plot', u'mapfeature_ptr_id', self.gf('django.db.models.fields.related.OneToOneField')(default=0, to=orm['treemap.MapFeature'], unique=True, primary_key=True))
        # Adding unique constraint on 'Plot', fields [u'mapfeature_ptr']
        db.create_unique(u'treemap_plot', [u'mapfeature_ptr_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Plot', fields [u'mapfeature_ptr']
        db.delete_unique(u'treemap_plot', [u'mapfeature_ptr_id'])


        # User chose to not deal with backwards NULL issues for 'Tree.plot'
        raise RuntimeError("Cannot reverse this migration. 'Tree.plot' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Plot.udfs'
        raise RuntimeError("Cannot reverse this migration. 'Plot.udfs' and its values cannot be restored.")
        # Adding field 'Plot.address_street'
        db.add_column(u'treemap_plot', 'address_street',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Plot.address_zip'
        db.add_column(u'treemap_plot', 'address_zip',
                      self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Plot.address_city'
        db.add_column(u'treemap_plot', 'address_city',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Plot.readonly'
        db.add_column(u'treemap_plot', 'readonly',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Plot.id'
        raise RuntimeError("Cannot reverse this migration. 'Plot.id' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Plot.instance'
        raise RuntimeError("Cannot reverse this migration. 'Plot.instance' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Plot.geom'
        raise RuntimeError("Cannot reverse this migration. 'Plot.geom' and its values cannot be restored.")

        # Changing field 'Plot.mapfeature_ptr'
        db.alter_column(u'treemap_plot', 'mapfeature_ptr_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['treemap.MapFeature'], null=True))
