...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'treemap_species', 'native_status')
        # Changing field 'Species.native_status'
        db.add_column(u'treemap_species', 'native_status',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True))

    def backwards(self, orm):
        raise Exception("you don't want to go back there...")
