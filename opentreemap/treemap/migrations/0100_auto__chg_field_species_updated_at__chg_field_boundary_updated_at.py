...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        default_time = datetime.datetime(2000, 1, 1, 0, 0)

        # Changing field 'Species.updated_at'
        orm['treemap.Species'].objects.filter(updated_at__isnull=True).update(updated_at=default_time)
        db.alter_column(u'treemap_species', 'updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=default_time))

        # Changing field 'Boundary.updated_at'
        orm['treemap.Boundary'].objects.filter(updated_at__isnull=True).update(updated_at=default_time)
        db.alter_column(u'treemap_boundary', 'updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=default_time))

    def backwards(self, orm):

        # Changing field 'Species.updated_at'
        db.alter_column(u'treemap_species', 'updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True))

        # Changing field 'Boundary.updated_at'
        db.alter_column(u'treemap_boundary', 'updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True))
