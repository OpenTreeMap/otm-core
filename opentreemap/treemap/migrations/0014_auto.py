...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Audit', fields ['model_id']
        db.create_index(u'treemap_audit', ['model_id'])

        # Adding index on 'Audit', fields ['model']
        db.create_index(u'treemap_audit', ['model'])


    def backwards(self, orm):
        # Removing index on 'Audit', fields ['model']
        db.delete_index(u'treemap_audit', ['model'])

        # Removing index on 'Audit', fields ['model_id']
        db.delete_index(u'treemap_audit', ['model_id'])
