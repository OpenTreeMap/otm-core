...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BenefitCurrencyConversion'
        db.create_table(u'treemap_benefitcurrencyconversion', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('currency_symbol', self.gf('django.db.models.fields.CharField')(max_length=5)),
            ('kwh_to_currency', self.gf('django.db.models.fields.FloatField')()),
            ('stormwater_gal_to_currency', self.gf('django.db.models.fields.FloatField')()),
            ('carbon_dioxide_lb_to_currency', self.gf('django.db.models.fields.FloatField')()),
            ('airquality_aggregate_lb_to_currency', self.gf('django.db.models.fields.FloatField')()),
        ))
        db.send_create_signal(u'treemap', ['BenefitCurrencyConversion'])

        # Adding field 'Instance.eco_benefits_conversion'
        db.add_column(u'treemap_instance', 'eco_benefits_conversion',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['treemap.BenefitCurrencyConversion'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'BenefitCurrencyConversion'
        db.delete_table(u'treemap_benefitcurrencyconversion')

        # Deleting field 'Instance.eco_benefits_conversion'
        db.delete_column(u'treemap_instance', 'eco_benefits_conversion_id')
