...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.execute('ALTER TABLE treemap_audit ALTER COLUMN id TYPE bigint');
        db.execute('ALTER TABLE treemap_audit ALTER COLUMN ref_id TYPE bigint');

    def backwards(self, orm):
        db.execute('ALTER TABLE treemap_audit ALTER COLUMN id TYPE int');
        db.execute('ALTER TABLE treemap_audit ALTER COLUMN ref_id TYPE int');
