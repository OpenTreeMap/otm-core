...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'InstanceUser', fields ['instance', 'user']
        db.create_unique(u'treemap_instanceuser', ['instance_id', 'user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'InstanceUser', fields ['instance', 'user']
        db.delete_unique(u'treemap_instanceuser', ['instance_id', 'user_id'])
