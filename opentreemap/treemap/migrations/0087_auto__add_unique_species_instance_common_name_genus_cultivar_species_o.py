...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Species', fields ['instance', 'common_name', 'genus', 'cultivar', 'species', 'other_part_of_name']
        db.create_unique(u'treemap_species', ['instance_id', 'common_name', 'genus', 'cultivar', 'species', 'other_part_of_name'])


    def backwards(self, orm):
        # Removing unique constraint on 'Species', fields ['instance', 'common_name', 'genus', 'cultivar', 'species', 'other_part_of_name']
        db.delete_unique(u'treemap_species', ['instance_id', 'common_name', 'genus', 'cultivar', 'species', 'other_part_of_name'])
