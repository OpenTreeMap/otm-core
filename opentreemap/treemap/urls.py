...
urlpatterns = patterns(
    ...
    url(r'^plots/(?P<feature_id>\d+)/photo/(?P<photo_id>\d+)$',
        routes.delete_photo, name='delete_photo_from_plot'),
    url(r'^plots/(?P<feature_id>\d+)/tree/\d+/photo/(?P<photo_id>\d+)$',
        routes.delete_photo, name='delete_photo_from_tree'),
