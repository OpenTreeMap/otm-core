...
UNIT_TEST_STORAGE_UNITS = {"test": {"separate_units": "in"}}


@override_settings(
    DISPLAY_DEFAULTS=UNIT_TEST_DISPLAY_DEFAULTS, STORAGE_UNITS=UNIT_TEST_STORAGE_UNITS
)
class UnitConverterTest(OTMTestCase):
    ...
    def test_is_convertible_or_formatable(self):
        ...
        self.assertTrue(is_convertible_or_formattable("test", "separate_units"))
    ...
    def test_get_storage_value(self):
        ...
        self.assertAlmostEqual(
            1, get_storage_value(self.instance, "test", "unit_only", 12)
        )
...
INTEGRATION_TEST_DISPLAY_DEFAULTS = {
    "plot": {"width": {"units": "ft", "digits": 2}},
    "tree": {"diameter": {"units": "in", "digits": 2},},
}
