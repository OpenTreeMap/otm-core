...
class VisitedInstancesTests(ViewTestCase):
    def setUp(self):
        ...
        InstanceUser(
            instance=self.instance4, user=self.user, role=self.instance4.default_role
        ).save_base()
    ...
    def test_session(self):
        ...
        self.assertEqual(
            self.client.get("/test-last-instance").content,
    ...
    def test_get_last_instance(self):
        ...
        self.assertEqual(self.instance1, get_last_visited_instance(self.request))

        add_visited_instance(self.request, self.instance2)
        self.assertEqual(self.instance2, get_last_visited_instance(self.request))
