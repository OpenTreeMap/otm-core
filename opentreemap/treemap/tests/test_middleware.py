...
class MockRequest:
    def __init__(self, http_user_agent=None, path_info="/", other_params=None):
        self.META = {"HTTP_USER_AGENT": http_user_agent, "PATH_INFO": path_info}
        if other_params:
...
class InternetExplorerRedirectMiddlewareTests(OTMTestCase):
    ...
    def test_does_not_detect_ie(self):
        ...
        self.assertIsNone(
            req.ie_version, 'Expected the middleware to set "ie_version" ' "to None"
        )
    ...
    def test_sets_version_and_does_not_redirect_for_ie_11(self):
        ...
        self.assertIsNone(
            res,
            "Expected the middleware to return a None "
            "response (no redirect) for IE 11",
        )
        self.assertEquals(
            11, req.ie_version, "Expected the middleware to " 'set "ie_version" to 11'
        )

    def test_sets_version_and_redirects_ie_10(self):
        req, res = self._request_with_agent(USER_AGENT_STRINGS.IE_10)
        self._assert_redirects(res, settings.IE_VERSION_UNSUPPORTED_REDIRECT_PATH)
        self.assertEquals(
            10, req.ie_version, "Expected the middleware to set " '"ie_version" to 10'
        )
    ...
    def test_sets_version_and_redirects_ie_9(self):
        ...
        self._assert_redirects(res, settings.IE_VERSION_UNSUPPORTED_REDIRECT_PATH)
        self.assertEquals(
            9, req.ie_version, "Expected the middleware to set " '"ie_version" to 9'
        )
    ...
    def test_sets_version_and_redirects_ie_8(self):
        ...
        self._assert_redirects(res, settings.IE_VERSION_UNSUPPORTED_REDIRECT_PATH)
        self.assertEquals(
            8, req.ie_version, "Expected the middleware to set " '"ie_version" to 8'
        )
    ...
    def test_sets_version_and_redirects_ie_7(self):
        ...
        self._assert_redirects(res, settings.IE_VERSION_UNSUPPORTED_REDIRECT_PATH)
        self.assertEquals(
            7, req.ie_version, "Expected the middleware to set " '"ie_version" to 7'
        )
    ...
    def test_sets_version_and_redirects_ie_6(self):
        ...
        self._assert_redirects(res, settings.IE_VERSION_UNSUPPORTED_REDIRECT_PATH)
        self.assertEquals(
            6, req.ie_version, "Expected the middleware to set " '"ie_version" to 6'
        )
    ...
    def test_detects_json_and_does_not_redirect(self):
        ...
        req, res = self._request_with_agent(
            USER_AGENT_STRINGS.IE_8, other_params=params
        )
