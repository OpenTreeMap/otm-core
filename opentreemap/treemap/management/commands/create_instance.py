...
from treemap.models import Boundary, InstanceUser, User, BenefitCurrencyConversion
...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument("instance_name", help="Specify instance name"),
        parser.add_argument(
            "--user", required=True, dest="user", help="Specify admin user name"
        ),
        parser.add_argument(
            "--center",
            dest="center",
        ...
        parser.add_argument(
            ...
            dest="geojson",
            help=(
                "Specify a boundary via a geojson file. Must be "
        ...
        parser.add_argument(
            ...
            dest="url_name",
            help=(
                'Specify a "url_name" starting with a lowercase letter and '
    ...
    def handle(self, *args, **options):
        ...
        if options.get("center", None) and options.get("geojson", None):
            ...
            raise Exception(
                "You must specifiy at least one of " '"center" and "geojson"'
            )
        ...
        eco_benefits_conversion = BenefitCurrencyConversion.get_default_for_instance(
            instance
        )
        ...
        InstanceUser(
            instance=instance, user=user, role=role, admin=True
        ).save_with_user(user)
