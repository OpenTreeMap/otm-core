...
module.exports.init = function(options) {
    ...
    $imageContainer.on('click', '[href="' + options.lightbox + '"]', function(e) {
        ...
        var isDeletable = isPhotoDeletable();
        $lightbox.find('[data-photo-confirm]').attr('data-photo-confirm', isDeletable ? endpoint : '');
        if (isDeletable) {
            $lightbox.find('[data-photo-confirm]').removeProp('disabled');
    ...
    $lightbox.on('click', '[data-photo-cancel]', function(e) {
        $lightbox.find('[data-class]:not([data-class="view"])').hide();
        $lightbox.find('[data-class="view"]').show();
    });
