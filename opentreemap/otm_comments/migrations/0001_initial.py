...
class Migration(SchemaMigration):
    ...
    depends_on = (
        ("threadedcomments", "0002_set__last_child_id__on_delete__set_null"),
    )

    def forwards(self, orm):
        # Adding model 'EnhancedThreadedComment'
        db.create_table(u'otm_comments_enhancedthreadedcomment', (
        ...
        db.send_create_signal(u'otm_comments', ['EnhancedThreadedComment'])


    def backwards(self, orm):
        # Deleting model 'EnhancedThreadedComment'
        db.delete_table(u'otm_comments_enhancedthreadedcomment')
