...
GENERIC_ERROR = e(6, _("An exception was raised while uploading the file"), True)
...
GEOM_OUT_OF_BOUNDS = e(11, _("Geometry must be inside the map bounds"), True)

EXCL_ZONE = e(12, _("Geometry may not be in an exclusion zone"), True)

INVALID_SPECIES = e(
    20, _("Could not find this scientific name on the " "master species list."), True
)
DUPLICATE_SPECIES = e(
    21, _("More than one species matches the given " "scientific name."), True
)

INVALID_PLOT_ID = e(
    30,
    _(
        "The given OpenTreeMap Planting Site ID does not "
        "exist in the system. This ID is automatically "
        "generated by OpenTreeMap and should only "
        "be used for updating existing records"
    ),
    True,
)
INVALID_TREE_ID = e(
    31,
    _(
        "The given OpenTreeMap Tree ID does not exist "
...
PLOT_TREE_MISMATCH = e(
    32,
    _(
        "The planting site specified by the given "
...
STRING_TOO_LONG = e(45, _("Strings must be less than 255 characters"), True)
...
ITREE_CODE_NOT_IN_REGION = e(63, _("i-Tree code not defined for region"), True)
INSTANCE_HAS_NO_ITREE_REGION = e(
    64,
    _("This treemap intersects no " "i-Tree regions and has no " "default region"),
    True,
)
...
NEARBY_TREES = e(1050, _("There are already trees within ten feet of this one"), False)
DUPLICATE_TREE = e(1051, _("There is already a tree at the specified location"), True)

SPECIES_DBH_TOO_HIGH = e(1060, _("The diameter is too large for this species"), False)

SPECIES_HEIGHT_TOO_HIGH = e(1061, _("The height is too large for this species"), False)
