...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SpeciesImportEvent.task_id'
        db.add_column(u'importer_speciesimportevent', 'task_id',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=50, blank=True),
                      keep_default=False)

        # Adding field 'TreeImportEvent.task_id'
        db.add_column(u'importer_treeimportevent', 'task_id',
                      self.gf('django.db.models.fields.CharField')(default=u'', max_length=50, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SpeciesImportEvent.task_id'
        db.delete_column(u'importer_speciesimportevent', 'task_id')

        # Deleting field 'TreeImportEvent.task_id'
        db.delete_column(u'importer_treeimportevent', 'task_id')
    ...
    models = {
        ...
        u'importer.speciesimportevent': {
            ...
            'task_id': ('django.db.models.fields.CharField', [], {'default': "u''", 'max_length': '50', 'blank': 'True'})
        },
