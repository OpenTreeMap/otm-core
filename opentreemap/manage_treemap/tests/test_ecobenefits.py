...
class BenefitsUpdateTest(OTMTestCase):
    def setUp(self):
        ...
        self.conversions = BenefitCurrencyConversion.get_default_for_region("PiedmtCLT")
    ...
    def test_update_some_values(self):
        ...
        self.assertEqual(conv.sox_lb_to_currency, 8.0)
    ...
    def test_error_on_blank(self):
        ...
        self.assertEqual(updated_instance.eco_benefits_conversion, self.conversions)
