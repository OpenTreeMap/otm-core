...
class ExternalLinkUpdateTest(OTMTestCase):
    ...
    def test_update_some_values(self):
        ...
        self.assertEqual(
            self.instance.config["externalLink.url"], "http://opentreemap.org/"
        )
        ...
        self.assertEqual(self.instance.config["externalLink.text"], "Different text")
        self.assertEqual(
            self.instance.config["externalLink.url"], "http://opentreemap.org/"
        )
        ...
        self.assertEqual(self.instance.config["externalLink.text"], "Different text")
        self.assertEqual(
            self.instance.config["externalLink.url"], "http://example.com/"
        )
    ...
    def test_error_with_omitted_field(self):
        ...
        with self.assertRaises(ValidationError):
            self.update_links({"instance.config.externalLink.url": ""})
