...
def update_instance_fields(request, instance, validation_fn=None):
    ...
    return _update_instance_fields(
        json_data, instance, validation_fn, should_update_universal_rev
    )


def _update_instance_fields(
    json_data, instance, validation_fn=None, should_update_universal_rev=False
):
    error_dict = {}
