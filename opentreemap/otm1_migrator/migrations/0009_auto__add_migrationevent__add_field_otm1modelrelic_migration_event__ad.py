...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MigrationEvent'
        db.create_table(u'otm1_migrator_migrationevent', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('completed', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('status', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'otm1_migrator', ['MigrationEvent'])

        # Adding field 'OTM1ModelRelic.migration_event'
        db.add_column(u'otm1_migrator_otm1modelrelic', 'migration_event',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['otm1_migrator.MigrationEvent'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'OTM1UserRelic.migration_event'
        db.add_column(u'otm1_migrator_otm1userrelic', 'migration_event',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['otm1_migrator.MigrationEvent'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'OTM1CommentRelic.migration_event'
        db.add_column(u'otm1_migrator_otm1commentrelic', 'migration_event',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['otm1_migrator.MigrationEvent'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'MigrationEvent'
        db.delete_table(u'otm1_migrator_migrationevent')

        # Deleting field 'OTM1ModelRelic.migration_event'
        db.delete_column(u'otm1_migrator_otm1modelrelic', 'migration_event_id')

        # Deleting field 'OTM1UserRelic.migration_event'
        db.delete_column(u'otm1_migrator_otm1userrelic', 'migration_event_id')

        # Deleting field 'OTM1CommentRelic.migration_event'
        db.delete_column(u'otm1_migrator_otm1commentrelic', 'migration_event_id')
    ...
    models = {
        ...
        u'otm1_migrator.migrationevent': {
            'Meta': {'object_name': 'MigrationEvent'},
            'completed': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
        ...
        u'otm1_migrator.otm1commentrelic': {
            ...
            'migration_event': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['otm1_migrator.MigrationEvent']", 'null': 'True', 'blank': 'True'}),
        ...
        u'otm1_migrator.otm1userrelic': {
            'Meta': {'unique_together': "((u'otm2_model_name', u'otm1_model_id', u'instance'),)", 'object_name': 'OTM1UserRelic'},
            ...
            'otm2_model_id': ('django.db.models.fields.IntegerField', [], {}),
            'otm2_model_name': ('django.db.models.fields.CharField', [], {'default': "u'user'", 'max_length': '255'})
        },
