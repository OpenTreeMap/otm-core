...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OTM1UserRelic.otm2_model_name'
        db.add_column(u'otm1_migrator_otm1userrelic', 'otm2_model_name',
                      self.gf('django.db.models.fields.CharField')(default=u'user', max_length=255),
                      keep_default=False)

        # Adding unique constraint on 'OTM1UserRelic', fields ['instance', 'otm1_model_id', 'otm2_model_name']
        db.create_unique(u'otm1_migrator_otm1userrelic', ['instance_id', 'otm1_model_id', 'otm2_model_name'])


    def backwards(self, orm):
        # Removing unique constraint on 'OTM1UserRelic', fields ['instance', 'otm1_model_id', 'otm2_model_name']
        db.delete_unique(u'otm1_migrator_otm1userrelic', ['instance_id', 'otm1_model_id', 'otm2_model_name'])

        # Deleting field 'OTM1UserRelic.otm2_model_name'
        db.delete_column(u'otm1_migrator_otm1userrelic', 'otm2_model_name')
