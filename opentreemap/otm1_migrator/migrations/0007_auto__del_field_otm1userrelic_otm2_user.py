...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'OTM1UserRelic.otm2_user'
        db.delete_column(u'otm1_migrator_otm1userrelic', 'otm2_user_id')


    def backwards(self, orm):
        # Adding field 'OTM1UserRelic.otm2_user'
        db.add_column(u'otm1_migrator_otm1userrelic', 'otm2_user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=-1, to=orm['treemap.User']),
                      keep_default=False)
