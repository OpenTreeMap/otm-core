...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'OTM1ModelRelic', fields ['instance', 'otm1_model_id', 'otm2_model_name']
        db.create_unique(u'otm1_migrator_otm1modelrelic', ['instance_id', 'otm1_model_id', 'otm2_model_name'])

        # Adding unique constraint on 'OTM1CommentRelic', fields ['instance', 'otm1_model_id', 'otm2_model_name']
        db.create_unique(u'otm1_migrator_otm1commentrelic', ['instance_id', 'otm1_model_id', 'otm2_model_name'])


    def backwards(self, orm):
        # Removing unique constraint on 'OTM1CommentRelic', fields ['instance', 'otm1_model_id', 'otm2_model_name']
        db.delete_unique(u'otm1_migrator_otm1commentrelic', ['instance_id', 'otm1_model_id', 'otm2_model_name'])

        # Removing unique constraint on 'OTM1ModelRelic', fields ['instance', 'otm1_model_id', 'otm2_model_name']
        db.delete_unique(u'otm1_migrator_otm1modelrelic', ['instance_id', 'otm1_model_id', 'otm2_model_name'])
