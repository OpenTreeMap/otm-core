...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for user_relic in orm['otm1_migrator.OTM1UserRelic'].objects.all():
            user_relic.otm2_model_id = user_relic.otm2_user_id
            user_relic.save()

    def backwards(self, orm):
        for user_relic in orm['otm1_migrator.OTM1UserRelic'].objects.all():
            user_relic.otm2_user_id = user_relic.otm2_model_id
            user_relic.save()
