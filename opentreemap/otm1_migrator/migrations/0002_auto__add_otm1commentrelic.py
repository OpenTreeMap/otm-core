...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OTM1CommentRelic'
        db.create_table(u'otm1_migrator_otm1commentrelic', (
            ...
            ('otm2_model_name', self.gf('django.db.models.fields.CharField')(default=u'threadedcomment', max_length=255)),
            ('otm1_last_child_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'otm1_migrator', ['OTM1CommentRelic'])


    def backwards(self, orm):
        # Deleting model 'OTM1CommentRelic'
        db.delete_table(u'otm1_migrator_otm1commentrelic')
    ...
    models = {
        ...
        u'otm1_migrator.otm1commentrelic': {
            'Meta': {'object_name': 'OTM1CommentRelic'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
