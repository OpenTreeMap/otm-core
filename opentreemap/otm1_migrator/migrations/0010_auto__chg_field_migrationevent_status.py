...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MigrationEvent.status'
        db.alter_column(u'otm1_migrator_migrationevent', 'status', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):

        # Changing field 'MigrationEvent.status'
        db.alter_column(u'otm1_migrator_migrationevent', 'status', self.gf('django.db.models.fields.IntegerField')(null=True))
