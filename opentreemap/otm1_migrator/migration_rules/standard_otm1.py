...
MIGRATION_RULES = {
    "treephoto": {
        ...
        "dependencies": {"tree": "tree", "user": "reported_by"},
        "common_fields": {"photo"},
    ...
    "boundary": {
        ...
        "value_transformers": {"geometry": (lambda x: fromstr(x, srid=4326)),},
    },
    "tree": {
        "command_line_flag": "-t",
        "model_class": Tree,
        "dependencies": {"species": "species", "user": "steward_user", "plot": "plot"},
        "common_fields": {
            "readonly",
            "canopy_height",
            "date_planted",
    ...
    "species": {
        ...
        "renamed_fields": {
            ...
            "v_max_height": "max_height",
            "v_max_dbh": "max_diameter",
    ...
    "comment": {
        ...
        "dependencies": {"user": "user", "contenttype": "content_type"},
        "common_fields": {"comment", "is_public", "ip_address"},
    ...
    "threadedcomment": {
        ...
        "renamed_fields": {"date_submitted": "submit_date"},
        "removed_fields": {
            "markup",  # this is no longer in the schema
        ...
        "missing_fields": {"title", "tree_path", "last_child"},
    },
    "treefavorite": {
        "command_line_flag": "-o",
        "model_class": Favorite,
        "dependencies": {"user": "user", "tree": "tree"},
...
MODEL_ORDER = PRIORITY_ORDER + [
    model for model in MIGRATION_RULES if model not in PRIORITY_ORDER
]
