...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'APIAccessCredential'
        db.create_table(u'api_apiaccesscredential', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('access_key', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ...
        db.send_create_signal(u'api', ['APIAccessCredential'])


    def backwards(self, orm):
        # Deleting model 'APIAccessCredential'
        db.delete_table(u'api_apiaccesscredential')
